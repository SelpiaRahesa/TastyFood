<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="{{ url('home') }}" class="brand-link">
            ...
            <!--begin::Brand Text--> <span class="brand-text fw-light">TastyFood</span> <!--end::Brand Text--> </a>
                ...
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-table"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('tentang.index') }}" class="nav-link"> <i
                                    class="nav-icon bi bi-journal"></i>
                                <p>Tentang</p>
                            </a> </li>
                    </ul>
                    <ul class="nav nav-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('slider.index') }}" class="nav-link"> <i
                                    class="nav-icon bi bi-play-circle"></i>
                                <p>Slider</p>
                            </a> </li>
                    </ul>
                </li>
                <li class="nav-item"> <a href="{{ route('message.index') }}" class="nav-link"> <i
                            class="nav-icon bi bi-envelope-arrow-down"></i>
                        <p>Message</p>
                    </a> </li>
